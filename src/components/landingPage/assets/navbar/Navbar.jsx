...
const Navbar = ({ onRegisterSuccess, onLoginSuccess }) => {
  return (
    <nav className="w-[90vw] h-[60px] bg-white flex items-center justify-between px-[50px] py-[50px] rounded-t-[10px] shadow-md sm:border-bottom-none">
      <div className="flex items-center justify-between w-full h-full pr-[3vw]">
        <span className="flex items-center justify-center">
          <img
            src={logo}
            alt="Logo"
            className="ml-[.3vw] w-[130px] h-[100px] object-contain filter drop-shadow-lg"
          />
        </span>
